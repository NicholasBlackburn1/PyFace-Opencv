...
while True:
    ...
    for face in faces:
        ...
        for n in range(0, 68):
            ...
            right_eyebrow_1= (landmarks.part(22).y, landmarks.part(22).x)
            right_eyebrow_2= (landmarks.part(23).y, landmarks.part(23).x)
            right_eyebrow_3 =(landmarks.part(24).y, landmarks.part(24).x)
            ...
            eye_width = (hypot(left_eye_left_point[0] - left_eye_right_point[0], left_eye_left_point[1] - left_eye_right_point[1]))
            
            nose_width = (hypot(nose_left[0] - nose_right[0], nose_left[1]- nose_right[1] ))
            nose_height = (nose_width*0.77)
            
            eye_height = (eye_width*0.77)
            ...
            dimeye =(int(eye_width),int(eye_height))
            ...
            cv2.putText(frame,'eye pos new'+str(dimeye), 
